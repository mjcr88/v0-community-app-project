...
| Command | Description |
| ------- | ----------- |
| `/00_discovery` | Discovery/Design (Epics) |
| `/01_brainstorm` | Socratic discovery |
| `/02_review` | Issue review & enrichment |
| `/03_scope` | Implementation strategy & scope |
| `/04_build` | Implementation & verification |
| `/05_run_qa` | Quality Assurance workflow |
