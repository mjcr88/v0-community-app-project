...
### 3. Brainstorm Classification Standards (MANDATORY)
When providing a recommendation in `/brainstorm`, you MUST classify the item:
*   **Status**: Always set to "**In Review**".
*   **Priority**: **P0** (Critical), **P1** (Important), **P2** (Nice-to-have).
*   **Size**: **XS** (1h), **S** (1d), **M** (3d), **L** (1w), **XL** (>2w).
