...
interface Step3PricingVisibilityProps {
    formData: {
    ...
    onUpdate: (data: Partial<Step3PricingVisibilityProps["formData"]>) => void
}

export function Step3PricingVisibility({
    formData,
    categories,
    neighborhoods,
    onUpdate,
}: Step3PricingVisibilityProps) {
